...
class coinBay3: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate
    
{
    ...
    override func viewDidLoad() {
        ...
        devicePickerOptions = ["Choose your "+device,"Use "+deviceUC+" 1", "Use "+deviceUC+" 2", "Use "+deviceUC+" 3", "Use "+deviceUC+" 4", "Use "+deviceUC+" 5"];
