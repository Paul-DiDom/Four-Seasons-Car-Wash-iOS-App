...
class WashCodeCoinBay2: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        devicePickerOptions = ["Choose your "+device,"Use "+deviceUC+" 1", "Use "+deviceUC+" 2", "Use "+deviceUC+" 3", "Use "+deviceUC+" 4",
                               "Use "+deviceUC+" 5", "Use "+deviceUC+" 6", "Use "+deviceUC+" 7", "Use "+deviceUC+" 8", "Use "+deviceUC+" 9", "Use "+deviceUC+" 10", "Use "+deviceUC+" 11", "Use "+deviceUC+" 12"];
    }
