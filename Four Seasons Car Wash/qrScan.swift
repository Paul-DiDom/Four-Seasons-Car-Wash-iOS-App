...
class qrScan: UIViewController, AVCaptureMetadataOutputObjectsDelegate{
    ...
    override func viewDidLoad() {
        ...
        if (UserDefaults.standard.object(forKey: "wash") != nil)
        {
            wash = UserDefaults.standard.object(forKey: "wash") as! String
        }
        if (UserDefaults.standard.object(forKey: "amount") != nil)
        {
            amount = UserDefaults.standard.object(forKey: "amount") as! String
        }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if (UserDefaults.standard.object(forKey: "washChosen") != nil)
        {
            washChosen = UserDefaults.standard.object(forKey: "washChosen") as! Bool
        }
        if (washChosen == false) {
        ...
        if metadataObj.type == AVMetadataObject.ObjectType.qr {
            ...
            if metadataObj.stringValue != nil {
                ...
                if(metadataObj.stringValue == "tech1stautoteller" && x == 0) {
                    x = 1
                    UserDefaults.standard.set(false, forKey: "washChosen")
                    captureSession.stopRunning()
                    //print(metadataObj.stringValue!)
                    //print("t," + wash + " " + amount + ",6");
                    startRequest(type: "t", deviceChosen: wash, amountChosen: amount, code:"", equip: "6")
                }
            }
        }
    }
